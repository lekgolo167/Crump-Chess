...
import crump.chess.engine.pieces.Pawn;
import crump.chess.engine.pieces.Piece;
import crump.chess.engine.board.Board.Builder;
...
public abstract class Move {
    ...
    @Override
    public int hashCode() {
        int result = 31 + this.destinationCoordinate;
    ...
    public static class AttackMove extends Move {
        ...
        @Override
        public int hashCode() {
            return this.attackedPiece.hashCode() + hashCode();
        }
    ...
    public static final class PawnEnPassantAttackMove extends crump.chess.engine.board.Move.PawnAttackMove {
