    ...
    public void redo(final MoveLog moveLog) {
        ...
        for(final Move move : moveLog.getMoves()) {
            if(move.isAttack()) {
                ...
                if(takenPiece.getPieceAlliance().isWhite()) {
                    ...
                    throw new RuntimeException("Piece did not have a alliance!");
                }
            }
        }
        ...
        Collections.sort(whiteTakenPieces, new Comparator<Piece>() {
            ...
            public int compare(Piece o1, Piece o2) {
                return o1.getPieceValue() > o2.getPieceValue() ? 1 : o1.getPieceValue() < o2.getPieceValue() ? -1 : 0;
            }
        });
        ...
        for(final Piece takenPiece : whiteTakenPieces) {
            try {
                final BufferedImage image = ImageIO.read(new File("art/fancy/" + takenPiece.getPieceAlliance().toString().substring(0,1)+""+takenPiece.toString()+".gif"));
